...
func routerSetup() {
	...
	handler.Any("/api/*path", proxyHandler)
	endless.ListenAndServe(os.Getenv("HOST")+":"+PORT, handler)
}

func createRefreshRequest() *http.Request {
...
func proxyHandler(c *gin.Context) {
	...
	createForwardRequest(request, c)
...
func createForwardRequest(request *http.Request, c *gin.Context) {
